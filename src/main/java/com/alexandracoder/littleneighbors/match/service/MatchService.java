...
public interface MatchService {
    MatchEntity requestMatch(Long childAId, Long childBId);
    ...
    void respondToMatch(Long matchId, com.alexandracoder.littleneighbors.enums.MatchStatus status, String currentUserEmail);
}
